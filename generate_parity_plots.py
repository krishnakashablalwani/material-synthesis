...
def create_parity_plots(exp, theo, output_dir='.'):
    ...
    for prop in properties:
        ...
        output_path = Path('output') / f'parity_{safe_name}.png'
        plt.tight_layout()
...
def create_comparison_table(exp, theo, output_dir='.'):
    ...
    output_path_dir = Path('output')
    output_path_dir.mkdir(parents=True, exist_ok=True)
    output_path = output_path_dir / 'comparison_table.csv'
...
def create_summary_report(exp, theo, output_dir='.'):
    ...
    output_path_dir = Path('output')
    output_path_dir.mkdir(parents=True, exist_ok=True)
    output_path = output_path_dir / 'summary_report.txt'
