...
class PhotocatalysisPredictor:
    ...
    def create_training_data(self):
        training_data = {
            ...
            'bandgap_direct': [1.94, 1.93, 1.93, 1.92, 1.93, 1.93, 1.92, 1.93, 1.94, 1.93, 1.93, 1.94, 1.93],
            'rate_h2_evolved': [40, 85, 95, 105, 115, 130, 138, 140, 135, 120, 100, 92, 75],
    ...
    def train_models(self):
        ...
        y = df_train[['crystallite_size', 'surface_area',
                      'bandgap_direct', 'rate_h2_evolved', 'quantum_yield']].values
